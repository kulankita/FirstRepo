...
<body>
	<header>
		...
		<div class="p-5 text-center bg-image"
			...
			<div class="mask"
				style="background-color: rgba(0, 0, 0, 0.6); margin-top: 100px; width: 400px; padding: 3px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; padding-top: 5px;">
	...
	<div class="class=" container-lg" style="padding-top: 30px;" id="row">
		...
		<div class="row">
			...
			%>
			<h5
				style="text-align: center; background-color: rgba(102, 245, 66, 0.3); padding: 5px;"><%=request.getAttribute("Message")%></h5>
			<%
			}
			%>
			...
			<div class="col-sm-4">
				...
				<form action="cartservlet" method="post">
					...
					<input type="number" name="qnt" min="1" value="1"> <input
						type="submit" class="cbtn" value="Add to cart">
				</form>
			</div>
			<%
			}
