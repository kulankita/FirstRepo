...
body {
	background-color: rgb(159, 228, 247);
}
		...
		<div class="row">
			...
			<div class="d-flex justify-content-center">
				<form action="paymentservlet" method="post">
					...
					<textarea rows="4" cols="40" name="uaddr"
						placeholder="Enter Address" style="background-color:azure;"></textarea>
					<br> <input type="submit" value="Pay" style="width: 115px; padding: 3px; background-color:azure;">
				</form>
				<form action="cart.jsp"
					style="margin-top: 147px; margin-left: -110px">
					<input type="submit" value="Cancel"
						style="width: 115px; margin-top: 5px; padding: 3px; background-color:azure;">
				</form>
			</div>
		</div>
	</div>
